...
struct common_params {
    ...
    int32_t layer_window       =  0;   // number of CPU layers to window into GPU staging (0=disabled, -1=auto)
    bool    layer_prefetch     = true; // enable async prefetching for layer window
    ...
    bool kv_cache_paged    = false; // enable PagedAttention for KV cache
